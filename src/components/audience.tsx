  ...
  return (
    <section id="audience" className="border-t border-rule bg-paper py-20 lg:py-24">
      <div className="shell">
        ...
        <div className="mt-12 grid gap-px overflow-hidden rounded-[3px] border border-rule bg-rule md:grid-cols-2">
            ...
            <article key={card.title} className="bg-paper-alt p-8">
              ...
              <ul className="mt-6 space-y-3">
                {card.points.map((point) => (
                  <li key={point} className="flex gap-2 text-[0.8rem] font-medium leading-6 text-ink">
